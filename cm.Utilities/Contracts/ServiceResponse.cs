...
namespace cm.Utilities.Contracts
{
    public class ServiceResponse
    {
        ...
        internal static ServiceResponse Succeed(int statusCode, object data = default, string code = "", string message = "") => new ServiceResponse
        {
